...
@section('title')
Massage Gift Cards for London - from just GBP20 | {{ config('app.name') }}
@endsection

@section('description')
Treat someone to a home massage in London with an instant delivery gift voucher - perfect
for last-minute birthday gifts or any occasion. From just GBP20.
@endsection
                ...
                <div class="content-panel">
                    ...
                    <form method="post" action="{{ route('giftsPost') }}" id="frmGift">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label" for="immediately">When would you like us to send the gift voucher?</label>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary btn-block submit" type="submit">Continue to Payment</button>
                            </div>
                        </div>
