                ...
                <table class="table striped-table table-fixed">
                    <thead>
                        <tr>
                            <th scope="col" style="width: 8%;">
                                <a href="{{ route('admin.posts.index', array_merge(request()->query(), ['sort_by' => 'id', 'sort_order' => request('sort_order') === 'asc' ? 'desc' : 'asc'])) }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action">
                                    <a href="{{ route('admin.posts.edit', ['id' => $post->id]) }}" class="text-dark me-3">
                                        <i class="fa fa-pen"></i>
                                    </a>
                                    <a href="{{ route('admin.posts.destroy', ['id' => $post->id]) }}" class="text-danger" onclick="return confirm('Are you sure you want to delete this post?');">
