...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('admin.therapists.treatments', ['id' => $user->id]) }}">Therapist Profile</a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-12">
                <div class="card-style mb-30">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="health_renewal_date" id="health_renewal_date" class="form-control" placeholder="Health Renewal Date" value="{{ old('health_renewal_date', $user->therapist_profile->health_renewal_date ?? '') }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="about" class="form-control editor" id="about" placeholder="Enter CTA Text">@if($isEdit){{ $user->therapist_profile->about ?? '' }}@endif</textarea>
                        @error('about')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
